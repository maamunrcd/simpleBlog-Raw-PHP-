                ...
                <div class="col-md-10 col-sm-10 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="form-group">
                            <label for="post_title"><h4>Enter title here</h4></label>
                            <input name="add_arti_title" type="text" class="form-control" id="post_title">
                        </div>
                        <div class="form-group">
                            <label for="post_subtitle"><h5>Enter sub title</h5></label>
                            <input name="add_arti_subtitle" type="text" class="form-control" id="post_subtitle">
                        </div>
                        <div class="form-group">
                            <label for="editor"><h4>Post content</h4></label>
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <div class="x_panel">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="add_arti_visibitlie" id="visibility" class="form-control" id="sel1">
                                    ...
                                    <option value="1" selected="select">Published</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="control-group">
                                <div class="xdisplay_inputx form-group has-feedback">
                                    ...
                                    <input name="add_arti_date" type="text" class="form-control has-feedback-left" id="single_cal4" placeholder="00/00/0000" aria-describedby="inputSuccess2Status4">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true">
                                <input name="article_time" type="text" class="form-control" value="<?php echo $arti_pub_time_defo; ?>">
                        ...
                        <div class="form-group featured_image">
                            ...
                            <input name="add_arti_featured_img" type="hidden" class="featured_img_field" type="text" name="featured_img_src">
                            <img style="width:100%;height: 40%;margin:10px 0;" id="set_feture_img" src="">
                        ...
                        <div class="form-group">
                            <button style="width:100%;border-radius: 0;border:none;" type="submit" class="btn-lg btn-success" name="add_articale">Add and Publish</button>
                        </div>
